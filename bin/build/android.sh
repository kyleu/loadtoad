...
##
## Outputs:
##   - build/dist/loadtoad_<version>_android_aar.zip
##   - build/dist/loadtoad_<version>_android_apk.zip
...
GOARCH=arm64 time gomobile bind -o build/dist/mobile_android_arm64/loadtoad.aar -target=android -androidapi 21 github.com/kyleu/loadtoad/app/cmd
echo "gomobile for Android completed successfully, building distribution..."
cd "build/dist/mobile_android_arm64"
zip -r "../loadtoad_${TGT}_android_aar.zip" .
...
rm -rf ./app/libs
mkdir -p ./app/libs
cp ../mobile_android_arm64/loadtoad.aar ./app/libs/
cp ../mobile_android_arm64/loadtoad-sources.jar ./app/libs/

gradle assembleDebug
cd app/build/outputs/apk/debug
zip -r "$dir/../../build/dist/loadtoad_${TGT}_android_apk.zip" .

echo "Output written to [./build/dist/loadtoad_${TGT}_android_aar.zip] and [./build/dist/loadtoad_${TGT}_android_apk.zip]"

...
##
## Outputs:
##   - build/dist/loadtoad_<version>_ios_framework.zip
##   - build/dist/loadtoad_<version>_ios_app.zip
...
cd "$dir/../.."
echo "Output written to ./build/dist/loadtoad_${TGT}_ios_framework.zip and ./build/dist/loadtoad_${TGT}_ios_app.zip"

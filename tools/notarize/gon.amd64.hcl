...
notarize {
  path = "./build/dist/loadtoad_0.0.11_darwin_amd64_desktop.dmg"
  bundle_id = "dev.kyleu.loadtoad"
}
...
dmg {
  output_path = "./build/dist/loadtoad_0.0.11_darwin_amd64.dmg"
  volume_name = "Load Toad"
}

zip {
  output_path = "./build/dist/loadtoad_0.0.11_darwin_amd64_notarized.zip"
}

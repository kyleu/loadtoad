...
notarize {
  path = "./build/dist/loadtoad_0.1.6_darwin_arm64_desktop.dmg"
  bundle_id = "dev.kyleu.loadtoad"
}
...
dmg {
  output_path = "./build/dist/loadtoad_0.1.6_darwin_arm64.dmg"
  volume_name = "Load Toad"
}

zip {
  output_path = "./build/dist/loadtoad_0.1.6_darwin_arm64_notarized.zip"
}

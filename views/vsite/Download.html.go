...
//line views/vsite/Download.html:20
	streamdownloadShowLinks(qw422016, "server", "database", "Server Version", "A command line interface that can launch a web server or run commands", p.Links, p.Version, ps)
//line views/vsite/Download.html:20
	qw422016.N().S(`
  `)
//line views/vsite/Download.html:21
	streamdownloadShowLinks(qw422016, "desktop", "desktop", "Desktop Version", "Standalone application using your platform's native web viewer", p.Links, p.Version, ps)
//line views/vsite/Download.html:21
	qw422016.N().S(`
  `)
//line views/vsite/Download.html:22
	streamdownloadShowLinks(qw422016, "mobile", "mobile", "Mobile Version", "Libraries and apps for Mobile Platforms", p.Links, p.Version, ps)
//line views/vsite/Download.html:22
	qw422016.N().S(`
`)
...
//line views/vsite/Download.html:48
			qw422016.N().S(`              <a href="https://github.com/kyleu/loadtoad/releases/download/v`)

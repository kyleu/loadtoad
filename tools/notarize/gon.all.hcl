...
notarize {
  path = "./build/dist/loadtoad_0.1.4_darwin_all_desktop.dmg"
  bundle_id = "dev.kyleu.loadtoad"
}
...
dmg {
  output_path = "./build/dist/loadtoad_0.1.4_darwin_all.dmg"
  volume_name = "Load Toad"
}

zip {
  output_path = "./build/dist/loadtoad_0.1.4_darwin_all_notarized.zip"
}
